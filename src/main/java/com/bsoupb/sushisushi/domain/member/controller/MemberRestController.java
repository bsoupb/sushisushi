package com.bsoupb.sushisushi.domain.member.controller;
...
public class MemberRestController {
	...
	public Map<String, String> join(
			...
			User user = memberService.addUser(loginId, password, name, address, email, hp);
	...
	public Map<String, String> login(
		...
		User user = memberService.getUser(loginId, password);
